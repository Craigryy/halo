...
# @auth_app.route('/swagger/<path:path>')
# def send_swagger_ui(path):
#     return send_from_directory('swagger_ui/dist', path)

# @auth_app.route('/swagger')
# def swagger_ui():
#     return send_from_directory('swagger_ui/dist', 'index.html')
...
@auth_app.route('/user', methods=['GET'])
# @swag_from('swagger/get_all_users.yml')
@token_required
def get_all_users(current_user):
    if not current_user:
        return jsonify({'message': 'Cannot perform that function!'})
...
@auth_app.route('/user/<int:public_id>', methods=['GET'])
# @swag_from('swagger/get_one_user.yml')
@token_required
def get_one_user(current_user, public_id):
    if not current_user:
        return jsonify({'message': 'Cannot perform that function!'})
